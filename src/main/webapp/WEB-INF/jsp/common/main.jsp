...
<body>
	<div id="wrap">
		...
		<div id="container">
			<section id="content">
				<button type="button" id="btnSearchZipcode" name="btnSearchZipcode" class="btn_ty_s_c3" data-toggle="modal" data-target="#modalAddress">팝업 테스트용</button>
	...
	function logout() {
	    $.ajax({
	        ...
	        //url: "/api/common/auth/logout", // kubeadm (브라우저 -> 서버 간 통신)
